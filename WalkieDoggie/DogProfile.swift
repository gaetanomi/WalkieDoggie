...
var kiraQueen = DogProfile(name: "Kira Queen", age: 8, pictures: ["Koira1-Kira-1","Koira1-Kira-2","Koira1-Kira-3"], description: "Weight: a lot but she doesn't know and act like she's 200g. Favorite toy: everything that can chew and hide. Love: belly rubs and chicken meat. Hate: my sister and my nephew (they like to do makeup training on her).", sex: Sex.female, breed: .hamstaff, latitude: 40.811340, longitude: 14.348950)
